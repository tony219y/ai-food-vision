 ...
 return (
    <>
      ...
      <div className="container mx-auto px-4">
        {/* responsive 2-column on md+, stacked on mobile */}
        <div className="flex flex-col md:flex-row items-start gap-8">
          {/* LEFT: main uploader column */}
            ...
            <div className="flex flex-col items-center justify-center p-6 md:p-10">
              ...
              >
                ...
                <div
                  ...
                  className={[
                    "relative w-full h-64 md:h-72 lg:h-80 rounded-xl flex flex-col items-center justify-center",
                ...
                >
                  ...
                  {!preview && (
                    <div className="text-center text-gray-600 px-4">
                      <p className="text-orange-500 font-semibold text-2xl md:text-3xl my-2">
                    ...
                    <div className="flex flex-col items-center gap-3 px-4">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className="px-4 py-2 rounded-full border border-gray-300 hover:bg-gray-50 disabled:opacity-50"
                          disabled={isAnalyzing}
                        >
                          Clear
                        </button>
              ...
              {/* Result UI */}
              {result && (
                <div className="w-full max-w-[800px] space-y-6 mt-10">
          ...
          {/* RIGHT: ExamImage side panel (sticks on scroll for md+) */}
          <aside
            className="
